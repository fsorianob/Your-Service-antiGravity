        ...
        <div className="flex-1 animate-in fade-in duration-500">
            ...
            <section className="py-12 container mx-auto px-4 md:px-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <Link to="#" className="bg-card border border-white/10 p-6 rounded-xl hover:border-primary/50 transition-colors group">
            ...
            <section className="py-12 bg-card/30 border-t border-white/5">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <Button variant="outline" className="gap-2 text-white border-white/10 hover:bg-white/5">
